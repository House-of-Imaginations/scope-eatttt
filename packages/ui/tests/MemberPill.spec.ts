...
test("default member = pink fill, 2px stroke border, radius-full", async ({
	mount,
}) => {
...
test("host member fills banana-yellow and shows a marker", async ({
	mount,
}) => {
...
test("with image renders the avatar photo next to the name", async ({
	mount,
}) => {
